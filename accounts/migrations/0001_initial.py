    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_type', models.CharField(choices=[('full_time', 'Full-time'), ('part_time', 'Part-time'), ('internship', 'Internship'), ('contract', 'Contract'), ('other', 'Other')], max_length=20)),
                ('location', models.CharField(max_length=255)),
                ('salary_range', models.CharField(blank=True, max_length=100)),
                ('experience_level', models.CharField(blank=True, choices=[('entry', 'Entry'), ('mid', 'Mid'), ('senior', 'Senior'), ('lead', 'Lead')], max_length=20)),
                ('application_deadline', models.DateField()),
                ('skills_required', models.CharField(max_length=255)),
                ('industry', models.CharField(choices=[('it', 'IT'), ('telecom', 'Telecom'), ('healthcare', 'Healthcare'), ('finance', 'Finance'), ('education', 'Education'), ('other', 'Other')], max_length=30)),
